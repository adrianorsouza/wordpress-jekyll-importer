...
class FileHandler
{
     ...
     *
     * @param string
     * @throws JekyllImporter\FileHandlerException
     */
    public function write($filename, $content)
    {
        if ( !is_dir( dirname($filename) ) ) {
            throw new FileHandlerException(
                sprintf('Directory not found: %s', dirname($filename))
            );
        ...
        $this->setOutput('success', sprintf($success_message, $filename));
    ...
    public function getOutput()
    {
        ...
        $output .= "------------------------------". PHP_EOL;
        $output .= $count . ' files has been created' . PHP_EOL;
        $output .= "------------------------------". PHP_EOL;
        return $output;
    }
}
